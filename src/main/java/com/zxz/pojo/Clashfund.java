...
/**
 * Clashfund entity. @author MyEclipse Persistence Tools
 */

public class Clashfund implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = -876418800912886235L;
	...
	/** full constructor */
	public Clashfund(Date billDate, Integer sinId, String cliid, String clishortname, String currencyType,
