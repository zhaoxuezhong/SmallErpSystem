...
public class Orderdetails implements java.io.Serializable {
	...
	private static final long serialVersionUID = -4520158675530782228L;
	...
	private Date outStoreroom;
	private Double toutNumber;
	...
	/** full constructor */
	public Orderdetails(Integer coteMark, String matid, String matname, String matspec, String matunit, Integer number,
			Double agioAgoPrice, Double agio, Double price, Double money, Double cess, Double taxmoney,
			Double intaxmoney, String present, Double factCost, Double criterionCost, Date outStoreroom,
			Double toutNumber, String sinName, String originBillId, Integer enables, String safetyone,
			String safetytwo) {
		...
		this.outStoreroom = outStoreroom;
		this.toutNumber = toutNumber;
	...
	public Date getOutStoreroom() {
		return this.outStoreroom;
	}

	public void setOutStoreroom(Date outStoreroom) {
		this.outStoreroom = outStoreroom;
	}

	public Double getToutNumber() {
		return this.toutNumber;
	}

	public void setToutNumber(Double toutNumber) {
		this.toutNumber = toutNumber;
	}
