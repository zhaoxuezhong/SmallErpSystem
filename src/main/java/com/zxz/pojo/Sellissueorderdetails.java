...
/**
 * Sellissueorderdetails entity. @author MyEclipse Persistence Tools
 */

public class Sellissueorderdetails implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 5446580666088199889L;
