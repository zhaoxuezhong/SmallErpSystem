...
/**
 * Stockorder entity. @author MyEclipse Persistence Tools
 */
...
public class Stockorder implements java.io.Serializable {
	...
	private static final long serialVersionUID = 3966470168182509138L;
	...
	/** full constructor */
	public Stockorder(Integer sodlineid, String sodmaterielid, String sodmatid, String sodspec, Integer sodamount,
			Double sodpreprice, Integer sodagio, Double sodprice, Double sodsum, Integer sodcess, Double sodsumcess,
			Double sodsumprice, Date sodpreincomestorage, Integer sodpresent, String sodorigintype, String sodorigin,
