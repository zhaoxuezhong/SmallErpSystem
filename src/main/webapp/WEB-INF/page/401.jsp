...
<body class="clearfix">
	...
	<div id="container">
		...
		<button class="button huge anthracite-gradient glossy" style="width:36%" id="button1" onclick="javascript:location.href='<%=path%>/login.html'">马上登陆</button>
		<button class="button huge anthracite-gradient glossy" style="width:36%" id="button2" onclick="window.history.back();">返回</button>
	</div>
